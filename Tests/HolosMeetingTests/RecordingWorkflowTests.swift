...
func leaseHeldElsewhereSkipsPostProcessing() async throws {
    ...
    #expect(record.message?.contains("voiceislocal session diarize") == true)
    ...
    #expect(reporter.messages.contains("Another Voice is Local process is labelling this meeting."))
    #expect(outcome.archiveStatus == ArchiveStatus.audioOnly)
