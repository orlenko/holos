...
enum AboutCredits {
    static let fluidAudio = """
        Speaker labels are made by the bundled holos tool with FluidAudio 0.17.1 \
        (https://github.com/FluidInference/FluidAudio, tag v0.17.1, commit 5c51c5c9), licensed under the Apache \
        License 2.0. The Holos app does not link FluidAudio or include the models; see THIRD_PARTY_NOTICES.md for the \
        full license texts.
        """
    ...
    static let models = """
        ...
        df2625ac79a7ac6b65ad868fee6d80f320da4232), downloaded by `holos setup --speakers` and not included in the \
