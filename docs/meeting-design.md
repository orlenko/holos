...
- A meeting with a review open, opening, or still saving is in use: the automatic relabel
  skips it (`MeetingController.sessionsInUse`), as it skips a meeting a Meetings command
  runs for.
